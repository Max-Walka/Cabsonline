      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div className="flex gap-3">
          <input
            ...
            className={`flex-1 border rounded px-3 py-2 text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 ${inputError ? 'border-red-400' : 'border-gray-300'}`}
